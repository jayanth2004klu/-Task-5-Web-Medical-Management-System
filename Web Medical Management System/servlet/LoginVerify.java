        ...
        if(c>='0' && c<='9'){
            ...
            try {
                ...
                if(flag==1){
                    ...
                    db.close();
                    getServletInfo().getRequestDispatcher("/student_profile.jsp").forward(request, response);
                }
                else{
                  getServletInfo().getRequestDispatcher("/login.jsp").forward(request, response);
                }
                ...
                if(flag==1){
                    ...
                    if( designationId==9){
                       ...
                       // response.sendRedirect("doctor_first_if.jsp");
                        ...
                        //Pharmacist
                        getServletInfo().getRequestDispatcher("/user_profile.jsp").forward(request, response);
                    }
                    else{
                        // Employee Prescription
                        getServletInfo().getRequestDispatcher("/view_emp_prescription.jsp").forward(request, response);
                    }
